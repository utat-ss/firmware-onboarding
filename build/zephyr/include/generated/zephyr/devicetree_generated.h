 ...
 *
 * DTS input file:
 *   /home/zaraa/firmware-onboarding/build/zephyr/zephyr.dts.pre
 *
...
/* Helpers for dealing with node labels: */
#define DT_N_S_rtc_NODELABEL_NUM 2
#define DT_N_S_rtc_FOREACH_NODELABEL(fn) fn(rtc) fn(rtc0)
#define DT_N_S_rtc_FOREACH_NODELABEL_VARGS(fn, ...) fn(rtc, __VA_ARGS__) fn(rtc0, __VA_ARGS__)
...
#define DT_N_NODELABEL_rtc0         DT_N_S_rtc
